...
/** \mainpage RoboComp::MyFirstComponent
 *
 * \section intro_sec Introduction
 *
 * The MyFirstComponent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/MyFirstComponent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class MyFirstComponent : public RoboComp::Application
{
public:
	MyFirstComponent (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::MyFirstComponent::initialize()
{
...
int ::MyFirstComponent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::MyFirstComponent app(prefix, startup_check_flag);
